...
define LORA_GATEWAY_INSTALL_STAGING_CMDS
	$(INSTALL) -D -m 0755 $(@D)/libloragw/libloragw.a $(STAGING_DIR)/usr/include/lora_gateway/libloragw/libloragw.a
	...
	$(INSTALL) -D -m 0644 $(@D)/libloragw/inc/$(f) $(STAGING_DIR)/usr/include/lora_gateway/libloragw/inc/$(f)
